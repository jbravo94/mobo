...
const char* server = "ozi5ej3rgtoyuqqrlndad7ucju0rvjxf.lambda-url.eu-central-1.on.aws";
...
void setup_wifi() {
  ...
  String ssid = preferences.getString("ssid", "backup-buddy-wifi-ssid");
...
void loop_httpclient() {
  ...
  if (!client.connect(server, 443)) {
    ...
    // Make a HTTP request:
    client.println("POST https://ozi5ej3rgtoyuqqrlndad7ucju0rvjxf.lambda-url.eu-central-1.on.aws/ HTTP/1.0");
    client.println("Content-Type: " + content_type);
    client.println("Host: ozi5ej3rgtoyuqqrlndad7ucju0rvjxf.lambda-url.eu-central-1.on.aws");
